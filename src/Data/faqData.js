export const FaqPageData = [
  ...
  },
  {
    ...
    "answer": "Yes, one client can bring only one friend. Kids can’t be in the studio due to safety reasons.",
    "answer1": "EDIT: Now, due the COVID situation bringing a friend is not possible. You have to also wear a mask during whole session and clean, sanitize hands upon arrival."
  },
  {
